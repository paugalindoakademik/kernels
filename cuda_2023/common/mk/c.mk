...
run:
	@echo
	@$(shell echo $(RUNTIME_ENV)) LD_LIBRARY_PATH=$(LIB_PATH):$(MPI_LIB_PATH) $(BIN) $(ARGS)
	@echo

debug:
	@$(shell echo $(RUNTIME_ENV)) LD_LIBRARY_PATH=$(LIB_PATH):$(MPI_LIB_PATH) $(DEBUGGER) --args $(BIN) $(ARGS)
