...
class BenchImpl(object):
    ...
    def memcheck(self, benchmark, dataset, do_output=True, extra_opts=[], platform=None):
        """Run this benchmark implementation under cuda-memcheck."""
        ...
        def perform():
            ...
            ###
            rc = self.makefile(benchmark, action='memcheck', platform=platform, opt={"ARGS":args})
